...
export default function NewEventPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setTimeout(() => router.push(`/events/${json.data.id}`), 1000)
    } catch (err: unknown) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <h1 className="text-2xl font-bold text-gray-900">Create Blood Drive Event</h1>
      <p className="mt-1 text-sm text-gray-500">Set up event details and customize the donor registration form.</p>
